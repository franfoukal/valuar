    ...
    <nav class="mb-1 navbar navbar-expand-md navbar-dark <?= isHome($request) ? 'transparent' : 'bg-noche' ?> home">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light" href="ListaProduct.html">
            ...
            echo '
                     <div class="jumbotron animated fadeInDown slow">
                        <div class="container">
                            ...
                            <p><a class="btn bg-verde waves-effect waves-light btn-lg mt-5" href="#" role="button">Descubrí más »</a></p>
                        </div>
                    </div>
