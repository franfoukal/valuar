   ...
   <div class="row m-1">
     <div class="col col-xl-6 col-lg-12 col-md-12 bg-image-collar z-depth-1-half" style="background-attachment:fixed">
       <div class="bg-white" style="margin:10% 10%;padding:5%5%;">
         ...
         <ul style="list-style-type:none">
           <li><a href="tel:08001112233"><i class="fas fa-phone"></i> 0-800-111-2233</a></li>
         </ul>
         <h5><i class="fas fa-envelope"></i> Soporte general</h5>
         <ul style="list-style-type:none">
           <li><a href="mailto:valuarfullgroup@email.com"><i class="fas fa-envelope"></i> valuarfullgroup@email.com</a></li>
         </ul>
       </div>
     </div>
     <div class="col col-xl-6 col-lg-12 col-md-12">
         <!-- PREGUNTAS -->
         <!--Accordion wrapper-->
         <div class="accordion md-accordion mt-5 mx-3" id="accordionEx1" role="tablist" aria-multiselectable="true">

           <!-- Accordion card -->
           <div class="card">

             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo1">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta1"
                 aria-expanded="false" aria-controls="pregunta1" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta1" class="collapse" role="tabpanel" aria-labelledby="titulo1"
           ...
           <div class="card">
             ...
             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo2">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta2"
                 aria-expanded="false" aria-controls="pregunta2" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta2" class="collapse" role="tabpanel" aria-labelledby="titulo21"
               data-parent="#accordionEx1">
               <div class="card-body">
           ...
           <div class="card">
             ...
             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo3">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta3"
                 aria-expanded="false" aria-controls="pregunta3" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta3" class="collapse" role="tabpanel" aria-labelledby="titulo3"
               data-parent="#accordionEx1">
               <div class="card-body">
           ...
           <div class="card">
             ...
             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo4">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta4"
                 aria-expanded="false" aria-controls="pregunta4" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta4" class="collapse" role="tabpanel" aria-labelledby="titulo4"
               data-parent="#accordionEx1">
               <div class="card-body">
           ...
           <div class="card">
             ...
             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo5">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta5"
                 aria-expanded="false" aria-controls="pregunta5" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta5" class="collapse" role="tabpanel" aria-labelledby="titulo5"
               data-parent="#accordionEx1">
               <div class="card-body">
           ...
           <div class="card">
             ...
             <!-- Card header -->
             <div class="card-header" role="tab" id="titulo6">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#pregunta6"
                 aria-expanded="false" aria-controls="pregunta6" style="color:black">
                 <h5 class="mb-0">
             ...
             <!-- Card body -->
             <div id="pregunta6" class="collapse" role="tabpanel" aria-labelledby="titulo6"
               data-parent="#accordionEx1">
               <div class="card-body">
