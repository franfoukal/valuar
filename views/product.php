      ...
      <div class="container">
        <div class="row">
              ...
              <div id="carrusel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class="carousel-item active">
                    <img class="d-block img-fluid product-img" src="./assets/img/products/<?=$selectedProduct["photos"][0]?>"
                      alt="First slide">
                  </div>
                 
                  <!--Second slide-->
                  <div class="carousel-item">
                    <img class="d-block img-fluid product-img" src="./assets/img/products/<?=$selectedProduct["photos"][1]?>"
                      alt="Second slide">
                  </div>
                  
                  <!--Third slide-->
                  <div class="carousel-item">
                    <img class="d-block w-100" src="./assets/img/products/<?=$selectedProduct["photos"][2]?>"
                      alt="Third slide">
                  </div>
          ...
          <div class="col-12 col-md-7 my-auto">
            <div class="row">
              <div class="col-12">
                <h3 class='my-1 item-title card-title'>Anillo <?=$selectedProduct["name"]?></h3>
            ...
            <div class="row">
              <div class="col-12">
                <h3 class='h3 amount plain-text my-3 mx-auto'>$ <span id='precio'><?=$selectedProduct["price"]?></span></h3>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
