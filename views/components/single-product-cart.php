<li class="mb-4">
    <div class="row cart-item mx-2 px-2 z-depth-1-half">
        ...
        <div class="img-wrapper-cart col-5 col-md-3 col-lg-2">
            <img src="/valuar/<?= $product["photos"][0] ?>" alt="" class="cart-prod-img img-fluid rounded-circle bd-piel">
        </div>

        <h4 class="prod-name col-5 col-md-4 col-lg-3"><?= $product["name"] ?></h4>
        <a href="delete-cart-product/<?=$i?>" class="cart-delete rojo col-2 col-md-1 col-lg-1"><i class="fas fa-times"></i></a>
